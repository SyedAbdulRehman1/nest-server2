...
ChapterModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [chapters_controller_1.ChapterController],
        providers: [chapters_service_1.ChaptersService, mux_service_1.MuxService, prisma_service_1.PrismaService, auth_service_1.AuthService],
    })
], ChapterModule);
